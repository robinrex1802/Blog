...
const filteredComments = input.filter(comment =>
        ...
        <div className="navbar-header">
          <div className="d-flex">
            ...
            <div className="navbar-brand-box">
              <a href="admindashboard.html" className="logo logo-dark">
            ...
            <div className="row">
              <div className="col-12">
                <div className="page-title-box d-sm-flex align-items-center justify-content-between">
                  <h4 className="mb-sm-0 font-size-18">Comment List</h4>
                </div>
              </div>
            </div>
            {/* end page title */}
